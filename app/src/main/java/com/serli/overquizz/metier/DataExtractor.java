...
public class DataExtractor {
    ...
    private List<QuizzData> data;

    public static List<QuizzData> getData(InputStream asset) {
    ...
    private static Optional<TimeInterval> extractTimeInterval(final String text) {
        Optional<TimeInterval> result = Optional.absent();
        ...
        if(matcher.matches()) {
            ...
            Optional<Integer> startYear = Optional.absent();
            Optional<Integer> endYear   = Optional.absent();
